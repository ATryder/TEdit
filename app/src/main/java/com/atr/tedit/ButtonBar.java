...
public class ButtonBar {
    ...
    /*public void setToConfirm(final Callback<Boolean> cb) {
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                button_check.setScaleX(SCALE);
                button_check.setScaleY(SCALE);
                button_check.setAlpha(0);
                bar.addView(button_check);
                activeButtons.add(button_check);
                button_check.animate().alpha(1).scaleX(1).scaleY(1).setDuration(ANIMLENGTH)
                        .setInterpolator(new OvershootInterpolator());
                button_check.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                ...
                button_x.setScaleX(SCALE);
                button_x.setScaleY(SCALE);
                button_x.setAlpha(0);
                bar.addView(button_x);
                activeButtons.add(button_x);
                button_x.animate().alpha(1).scaleX(1).scaleY(1).setDuration(ANIMLENGTH)
                        .setInterpolator(new OvershootInterpolator());
                button_x.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
    ...
    public void setToClose(final Callback<Boolean> cb) {
